...
# test = load_dataset("/home/gpl/Documents/DLP/lab3/dataset/oxford-iiit-pet", "train")
# print(test[0])
# print(f'image shape:{test[0].get("image").shape}, mask shape: {test[0].get("mask").shape}')